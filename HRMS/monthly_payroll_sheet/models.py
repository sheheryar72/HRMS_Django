...
class HR_MONTHLY_PAY_SHEET(models.Model):
    ...
    Conveyance_Fixed_Allowance_3 = models.IntegerField(blank=True, null=True)
    Overtime_Allowance_4 = models.IntegerField(blank=True, null=True)
    House_Rent_Allowance_5 = models.IntegerField(blank=True, null=True)
    ...
    Over_Utilization_Mobile_21 = models.IntegerField(blank=True, null=True)
    Vehicle_Fuel_Deduction_22 = models.IntegerField(blank=True, null=True)
    ...
    Tot_Deductions = models.FloatField(blank=True, null=True)
    Tot_AC_To_WD = models.FloatField(blank=True, null=True)
    Tot_Net_Salary = models.FloatField(blank=True, null=True)
